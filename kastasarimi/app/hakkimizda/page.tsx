...
export const metadata: Metadata = buildMetadata({
  title: "Hakkımızda — Ankara'da Güvenilir Kaş Tasarımı | Stria Studio",
  description:
    "Stria Studio, Ankara Çankaya'da sertifikalı uygulayıcılarla kaş tasarımı ve kaş tasarımı yapar. Hijyen, deneyim ve doğal sonuç odaklı yaklaşımımız.",
  path: "/hakkimizda",
});
