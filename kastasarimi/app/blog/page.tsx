...
export const metadata: Metadata = buildMetadata({
  title: "Kaş Tasarımı Blog — Rehberler ve Sık Sorulan Sorular",
  description:
    "Kaş Tasarımı hakkında bilmeniz gereken her şey: fiyatlar, kalıcılık, bakım, iyileşme ve daha fazlası. Ankara Stria Studio uzman rehberleri.",
  path: "/blog",
});
...
export default async function BlogIndexPage({
  ...
  return (
    <>
      ...
      <Section as="h1" eyebrow="Blog" heading="Kaş Tasarımı rehberi"
