    ...
    <>
      ...
      <Section eyebrow="Geliştiriciler" heading="API Dokümantasyonu"
        ...
        <div className="mt-6 flex flex-wrap gap-3 text-[14px]">
          <a href="/openapi.yaml" className="rounded-[16px] border border-line bg-white px-4 py-2 text-accent-dark hover:bg-blush/50">
            OpenAPI 3.1 şeması (openapi.yaml)
          </a>
          <span className="rounded-[16px] border border-line bg-white px-4 py-2 text-muted2">
          ...
          {endpoints.map((e) => (
            <div key={e.method + e.path} className="overflow-hidden rounded-[16px] border border-line bg-white">
              ...
              <div className="px-5 py-4">
                ...
                <pre className="mt-3 overflow-x-auto rounded-[16px] bg-ink/95 p-4 text-[12.5px] leading-relaxed text-cream">
                  <code>{e.sample}</code>
                </pre>
              </div>
            </div>
