...
export const metadata: Metadata = buildMetadata({
  title: "Kaş Tasarımı Galeri — Öncesi & Sonrası (Ankara)",
  description:
    "Ankara Stria Studio kaş tasarımı öncesi ve sonrası çalışmaları. Kıl tekniğiyle yapılan doğal kaş tasarımı örneklerini inceleyin.",
  path: "/galeri",
});
