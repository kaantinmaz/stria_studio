        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(290px,1fr))] gap-[18px]">
          {services.map((s) => (
            <Link
              ...
              className="group flex flex-col overflow-hidden rounded-[24px] border border-line bg-white transition duration-300 hover:-translate-y-1 hover:shadow-[0_30px_60px_-40px_rgba(76,19,19,0.5)]"
            >
