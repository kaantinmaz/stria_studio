...
export function CookieConsent() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-0 bottom-0 z-[90] border-t border-line2 bg-cream/95 px-[clamp(16px,4vw,40px)] py-3 shadow-[0_-12px_36px_-24px_rgba(66,48,46,0.55)] backdrop-blur-md"
    >
